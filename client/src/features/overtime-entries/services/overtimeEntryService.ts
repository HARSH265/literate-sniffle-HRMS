...
export const overtimeEntryService = {
  ...
  async getById(id: string): Promise<{ success: boolean; data: OvertimeEntry }> {
  ...
  async update(id: string, payload: Partial<CreateOvertimeEntry>): Promise<{ success: boolean; data: OvertimeEntry }> {
