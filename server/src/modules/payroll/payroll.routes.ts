...
router.post('/preview', authorize('process-payroll'), payrollController.previewRun);
router.get('/run/:id', authorize('process-payroll'), payrollController.getRunDetails);
router.post('/run/:id/submit', authorize('process-payroll'), payrollController.submitRun);
router.post('/run/:id/approve', authorize('process-payroll'), payrollController.approveRun);
router.post('/run/:id/reject', authorize('process-payroll'), payrollController.rejectRun);
router.patch('/run/:id/item/:itemId', authorize('process-payroll'), payrollController.updatePayrollItem);
router.patch('/run/:id/items/batch', authorize('process-payroll'), payrollController.batchUpdateItems);
