...
router.patch('/run/:id/item/:itemId', authorize('process-payroll'), validate(payrollIdParamSchema, 'params'), validate(updatePayrollItemSchema), payrollController.updatePayrollItem);
