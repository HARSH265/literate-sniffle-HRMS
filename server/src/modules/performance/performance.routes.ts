...
router.patch('/reviews/:id/goals', authorize('manage-own-performance'), validate(setGoalsSchema), performanceController.setGoals);
router.patch('/reviews/:id/self-review', authorize('manage-own-performance'), validate(submitSelfReviewSchema), performanceController.submitSelfReview);
...
router.post('/reviews/:id/appeal', authorize('manage-own-performance'), validate(appealReviewSchema), performanceController.appealReview);
